...
<title>MWAP</title>
  ...
  <script type="text/javascript" src="waveform-playlistAudio.var.js"></script>
...
<?php include "MyPhP.php"; 
$Info =  explode( '_', $DirFolder[$_GET['varname']]);
...
playlist.load([
  ...
  //can do stuff with the playlist.
    ...
    <script type="text/javascript" src="emitterAudio.js"></script>
